...
g = graphviz.Digraph('NGCF_model5', format='pdf', node_attr={'shape': 'record'}, engine='dot')
g.attr(rankdir='TD')
...
g.edge('i_e_1', 'Linear1:in')
g.edge('u_e_1', 'Linear4:in')
...
g.edges([('u_e', 'sddmm1:in'),  ('i_e_2', 'sddmm1:in')])
g.edges([('u_e_2', 'sddmm2:in'),  ('i_e', 'sddmm2:in')])

g.edge('norm_edge', 'spmm1:in')
g.edge('norm_edge_1', 'spmm4:in')
...
g.edge('spmm1:out', 'add1')
g.edge('spmm4:out', 'add2')

g.edge('sddmm1:out', 'Linear2:in')
g.edge('sddmm2:out', 'Linear3:in')
g.edge('Linear2:out', 'mul1')
g.edge('Linear3:out', 'mul2')

g.edge('mul1', 'spmm2')
g.edge('mul2', 'spmm3')


g.render(filename='model_3', directory="./",view=False)
