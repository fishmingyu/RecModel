...
with g.subgraph(name='out') as c:
    c.node_attr.update(color='gray', stype='filled', fillcolor='white')
    c.node('i_e_o', nohtml(r'item embedding\' | \[M, d\]'))

g.edges([('u_e', 'spmm1:in'), ('sddmm1:out', 'spmm2:in'), ('spmm2:out', 'Linear2:in')])
# g.edge('sddmm2:out', 'spmm3:in')
...
g.edge('mul1', 'sddmm1:in')
g.edge('mul2', 'sddmm1:in')
...
g.edge('add1', 'i_e_o')
g.edge('spmm_i:out', 'add3')
g.edge('spmm1:out', 'add3')
g.edge('add3', 'Linear1:in')
# g.edge('spmm_u:out', 'add4')
# g.edge('spmm4:out', 'add4')
# g.edge('add4', 'Linear4:in')
# g.edge('u_e_1', 'spmm_u')
g.edge('i_e_1', 'spmm_i')
g.render(filename='model_4', directory="./",view=False)
